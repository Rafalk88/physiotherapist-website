        ...
        >
          ...
          <ol className="pl-6 pt-2">
            ...
            >
              ...
              <span className="font-bold">siltim.com</span>
                &nbsp;jest
              <span className="font-bold">Siltim Sp. z o.o.</span>
                &nbsp;wpisana do rejestru przedsiębiorców przez właściwy sąd pod numerem KRS:&nbsp;
              <span className="font-bold">0000934584</span>
              , kapitał zakładowy: 5304,00 PLN, miejsce
            ...
            >
              ...
              <ol className="pl-6 pt-2">
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Dostęp do danych</span>
                  {' '}
                  – art. 15 RODO
                </Typography>
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Sprostowanie danych</span>
                  {' '}
                  – art. 16 RODO.
                </Typography>
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Usunięcie danych (tzw. prawo do bycia zapomnianym)</span>
                  {' '}
                  – art. 17 RODO.
                </Typography>
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Ograniczenie przetwarzania</span>
                  {' '}
                  – art. 18 RODO.
                </Typography>
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Przeniesienie danych</span>
                  {' '}
                  – art. 20 RODO.
                </Typography>
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Sprzeciw</span>
                  {' '}
                  – art. 21 RODO
                </Typography>
                <Typography
                  ...
                  as="li"
                >
                  <span className="font-bold">Cofnięcie zgody</span>
                  {' '}
                  – art. 7 ust. 3 RODO.
                </Typography>
              </ol>
